...
namespace RpgEditor
{
    public partial class FormWeaponDetails : Form
    {
        ...
        void FormWeaponDetails_Load(object sender, EventArgs e)
        {
            ...
            foreach (Mechanics.DieType die in Enum.GetValues(typeof(Mechanics.DieType)))
                cboDieType.Items.Add(die);

            cboHands.SelectedIndex = 0;
            cboDieType.SelectedIndex = 0;
            cboDieType.SelectedValue = Enum.GetName(typeof(Mechanics.DieType), Mechanics.DieType.D4);
