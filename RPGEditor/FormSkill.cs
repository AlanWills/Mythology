    ...
    public partial class FormSkill : FormDetails
    {
        ...
        void btnEdit_Click(object sender, EventArgs e)
        {
            if (lbDetails.SelectedItem != null)
            {
                ...
                SkillData data = SkillDataManager.Dictionary[entity];
                ...
                using (FormSkillDetails frmSkillData = new FormSkillDetails())
                {
                    ...
                    {
                        SkillDataManager.Dictionary[entity] = frmSkillData.Skill;
                        FillListBox();
                        return;
                    }
                ...
                if (SkillDataManager.Dictionary.ContainsKey(newData.Name))
                {
                ...
                SkillDataManager.Dictionary.Add(newData.Name, newData);
            }
        }
        ...
        void btnDelete_Click(object sender, EventArgs e)
        {
            if (lbDetails.SelectedItem != null)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    SkillDataManager.Dictionary.Remove(entity);
        ...
        public void FillListBox()
        {
            ...
            foreach (string s in FormDetails.SkillDataManager.Dictionary.Keys)
                lbDetails.Items.Add(FormDetails.SkillDataManager.Dictionary[s]);
        }

        private void AddSkill(SkillData skillData)
        {
            if (FormDetails.SkillDataManager.Dictionary.ContainsKey(skillData.Name))
            {
                DialogResult result = MessageBox.Show(
                ...
                SkillDataManager.Dictionary[skillData.Name] = skillData;
                FillListBox();
                return;
            }
